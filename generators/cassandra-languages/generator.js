...
import { languagesSaathratriUtils } from './cassandra-languages-utils.js';
...
export default class extends BaseApplicationGenerator {
  ...
  get [BaseApplicationGenerator.WRITING]() {
    return this.asWritingTaskGroup({
      async writingTemplateTask({ application, entity }) {
        await this.writeFiles({
          sections: {
            files: [{ templates: ['template-file-cassandra-languages'] }],
          },
          context: application,
        });
      },
